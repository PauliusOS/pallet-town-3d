...
/**
 * Pidgey — placeholder stub. A proper capture-judged sculpt replaces this
...
export function buildPidgey(): Creature {
  ...
  const skin = creatureSkin({ color: 0xa8795a, subsurface: 0x86583e, wrap: 0.16, rim: 0.05, roughness: 0.9 });
